...
## [0.8.3](https://github.com/BryanCruz/petgraph/compare/petgraph@v0.8.2...petgraph@v0.8.3) - 2025-06-28

### Documentation

- Fix examples link in README and unify typesetting of one word ([#823](https://github.com/BryanCruz/petgraph/pull/823))
- Add link to multigraph definition to isomorphism algos ([#824](https://github.com/BryanCruz/petgraph/pull/824))
- Fix auxiliary space (and time) complexity of bron-kerbosch ([#825](https://github.com/BryanCruz/petgraph/pull/825))
- Fix Typo in Operator Module Documentation ([#831](https://github.com/BryanCruz/petgraph/pull/831))
- Sync the crate feature flags in the README and docs ([#832](https://github.com/BryanCruz/petgraph/pull/832))
- Remove all \[Generic\] tags from algo docstrings ([#835](https://github.com/BryanCruz/petgraph/pull/835))
- Fix typos in comments ([#836](https://github.com/BryanCruz/petgraph/pull/836))
- Revamp CONTRIBUTING.md ([#833](https://github.com/BryanCruz/petgraph/pull/833))
...
- add examples for scc algorithms and reorganize into dedicated module ([#830](https://github.com/BryanCruz/petgraph/pull/830))

### Testing

- Add dependency list for 'quickcheck' feature ([#822](https://github.com/BryanCruz/petgraph/pull/822))

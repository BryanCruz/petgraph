...
#[bench]
fn graph_from_graph6_str_complete_7(bench: &mut Bencher) {
    graph_from_graph6_bench(bench, r"F~~~w");
}

#[bench]
fn graph_from_graph6_str_petersen(bench: &mut Bencher) {
    graph_from_graph6_bench(bench, r"IheA@GUAo");
}

#[bench]
fn graph_from_graph6_str_62(bench: &mut Bencher) {
    graph_from_graph6_bench(
        bench,
...
#[bench]
fn graph_from_graph6_str_63(bench: &mut Bencher) {
    graph_from_graph6_bench(
        bench,
...
fn graph_from_graph6_bench(bench: &mut Bencher, graph6_str: &str) {
